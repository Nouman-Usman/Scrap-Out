...
<head>
    ...
    <title>SCRAP OUT</title>
    <link rel="icon" type="image/png/svg" href="assets/img/logo.png">
...
<body>
    <div class="container">
        ...
        <section class="opportunities">
            ...
            <div class="opportunities__content w-105">
                <div class="opportunities__head">
                    ...
                    <p class="opportunities__description">We are the first and the only crowdfunding platform enabling you to grow your scrapping buisness.</p>
                </div>
                <div class="opportunities__body">
                    <div class="opportunity">
                        <img src="assets/img/opportunites/opportunity-1.svg" alt="Icon" class="opportunity__icon">
                        <h4 class="opportunity__title">Connect with Scrap Buyers</h4>
                        <p class="opportunity__description">SCRAP OUT is the only platform who connects you with the buyers of you desired prices instantly. 
                        </p>
                    </div>
                    ...
                    <div class="opportunity active">
                        ...
                        <p class="opportunity__description">
                            Struggling to find the right scrap at the right price? <b>SCRAP OUT</b> connects you with sellers instantly! Our advanced search filters help you source specific materials efficiently, while secure communication tools facilitate smooth deals. Grow your business faster with <b>SCRAP OUT</b>: find hidden gems, build trust through reviews, and stay ahead with market insights. Join the<b>SCRAP OUT</b> community and watch your business flourish!
                        </p>
                    </div>
                    <div class="opportunity">
                        <img src="assets/img/recycle.png" alt="Icon" class="opportunity__icon">
                        <h4 class="opportunity__title">Recycle your waste
                        </h4>
                        <p class="opportunity__description">
                            SCRAP OUT plays a crucial role in facilitating scrap recycling by connecting two key players: scrap sellers and authorized recyclers/buyers.
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="works__content">
                ...
                <div class="works__footer">
                    <div class="works__step__content first_step">
                        <h3 class="works__step_title"> Register Yourself as a Seller/Buyer</h3>
                        <p class="works__step_description">
                            Simply Regiter Yourself as a seller or buyer by just clicking <br>
                            <a class="btn btn__farm--invest" href="register.php">Register Now</a>
                        </p>
                    </div>
                    <div class="works__step__content">
                        <h3 class="works__step_title"> Find the Buyer/Seller.</h3>
                        <p class="works__step_description">
                            Find the Buyer that suits your needs and get the best price for your scrap.
                        </p>
                    </div>
                    <div class="works__step__content">
                        <h3 class="works__step_title">Get paid by hand</h3>
                        <p class="works__step_description">
                            Get instantly paid by hand or by bank transfer for your scrap.
                            No fraoud, No hassle.
                        </p>
                    </div>
                    <div class="works__step__content">
        ...
        <section class="testimonials">
            <div class="testimonials__content">
                <div class="testimonials__head w-105">
                    ...
                    <h2 class="testimonials__title">What Users like you are saying about Scrap Out</h2>
                </div>
        ...
        <section class="farm-invest w-105">
            <h2 class="farm-invest__title">Turn Your Scrap into <span>Money</span> with Scrap Out </h2>
            <a href="register.php" class="btn btn__farm--invest">Register Now</a>
            ...
            <div class="footer__bottom">
                <div class="footer__bottom__content w-105">
                    <div class="footer__logo">
                        <img src="assets/img/logo.png" alt="Logo" height="100vh" width="100vw">
                    </div>
                    <p class="footer_copyright">
                        © Copyright 2024. Agile Developers.
                    </p>
                </div>
